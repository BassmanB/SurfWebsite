...
function openNav() {
    document.getElementById("myDIV").style.right = "400";
}
...
#hero{
height: 100vh;
/*background-image: url("../assets/rgb1.jpg");*/
background-size: cover;
background-repeat: no-repeat;
background-position: center center;
...
font-weight: 400;
margin:0;
font-family: 'Atmosphere', cursive;
color: white;
}
